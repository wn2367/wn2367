        ...
        <el-card>
            <el-table :data="userList" stripe style="width: 100%">
                ...
                <el-table-column label="操作" width="180">
                    <template slot-scope="scope">
                        <el-button @click="openEditUI(scope.row.id)" type="primary" plain>修改</el-button>
                        <el-button @click="deleteUser(scope.row)" type="danger" plain>删除</el-button>
        ...
        <el-dialog @close="clearForm" :title="title" :visible.sync="dialogFormVisible">
            <el-form :model="userForm" ref="userFormRef" :rules="rules">
                ...
                <el-form-item label="联系电话" prop="phone" :label-width="formLabelWidth">
                    <el-input v-model="userForm.phone" autocomplete="off" maxlength="11"></el-input>
                </el-form-item>
